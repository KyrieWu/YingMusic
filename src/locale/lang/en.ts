export default {
    ...
    login: {
        ...
        captcha: "Captcha",
        login: 'Login',
        loginWithCaptcha: 'Login with Captcha',
        loginWithPassword: 'Login with Password',
        sendCaptcha: "Send Captcha",
        notice: `Your password will be MD5 encrypted locally and then transmitted to NetEase Music API.
        YingMusic promises not to save any of your account information to the cloud.`,
    },
    mv: {
